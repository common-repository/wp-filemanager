...
{
 if ($_GET['type'] == "directory") check_admin_referer('create_directory');
 if ($_GET['type'] == "file") check_admin_referer('create_file');
 print "<table class='index' width=500 cellpadding=0 cellspacing=0>";
  ...
  print "<tr>";
   print "<td valign='top' colspan=2>";
    ...
    print "<center><br />";
// add wp_nounce for file and directory seperately.
